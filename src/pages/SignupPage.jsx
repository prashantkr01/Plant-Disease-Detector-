      ...
      >
        <div className="p-8 lg:p-12">
          ...
          <div className="flex flex-col items-center mb-10">
            ...
            <h1 className="text-3xl font-bold text-slate-900 dark:text-white transition-colors duration-500">Join PlantAI</h1>
            <p className="text-slate-500 dark:text-slate-400 mt-2 transition-colors duration-500">Start monitoring your plants today</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-sm font-semibold text-slate-700 dark:text-slate-300 ml-1 transition-colors duration-500">Full Name</label>
